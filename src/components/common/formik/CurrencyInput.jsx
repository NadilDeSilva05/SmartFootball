...
const CurrencyInput = props => {
  ...
  const { locale, currencyCode, currencyDisplay, useGrouping, minimumFractionDigits } = currencyConfig

  const valueDisplay = currency(valueInCents / 100).value.toLocaleString(locale, {
    style: 'currency',
  ...
  const inputProps = {
    ...
    style: style,
    value: valueDisplay.substring(1)
  }
